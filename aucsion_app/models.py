...
class User(AbstractUser):
    ...
    @staticmethod
    def _create_user(password, username, **extra_fields):
        if not username:
...
class Seller(models.Model):
    user = models.ForeignKey(
        User, verbose_name='User - Seller', related_name='user_seller', on_delete=models.CASCADE)
...
class SellerBlackList(models.Model):
    user = models.ForeignKey(
        User, verbose_name='User - Black List', related_name='user_blacklist', on_delete=models.CASCADE)
    seller = models.ForeignKey(
        Seller, verbose_name='Seller - Black List', related_name='seller_blacklist', on_delete=models.CASCADE)
...
class Buyer(models.Model):
    user = models.ForeignKey(
        User, verbose_name='User - Buyer', related_name='user_buyer', on_delete=models.CASCADE)
...
class BuyerBlackList(models.Model):
    buyer = models.ForeignKey(
        Buyer, verbose_name='User - Black List', related_name='buyer_blacklist', on_delete=models.CASCADE)
    reason = models.TextField('Reason', null=True, blank=True)
...
class AucsionHistory(models.Model):
    buyer = models.ForeignKey(
        Buyer, verbose_name='Buyer - bet', related_name='buyer_bet', on_delete=models.CASCADE)
    aucsion = models.ForeignKey(
        Aucsion, verbose_name='Aucsion - bet', related_name='aucsion_bet', on_delete=models.CASCADE)
...
class Product(models.Model):
    ...
    seller = models.ForeignKey(
        Seller, verbose_name='Seller - Product', related_name='seller_product', on_delete=models.CASCADE)
    aucsion = models.ForeignKey(
        Aucsion, verbose_name='Aucsion - product', related_name='aucsion_product', on_delete=models.CASCADE)
    ...
    def __str__(self):
        return str(self.seller) + ' - ' + str(self.aucsion)
...
class Purchase(models.Model):
    ...
    buyer = models.ForeignKey(
        Buyer, verbose_name='Buyer - purchase', related_name='buyer_purchase', on_delete=models.CASCADE)
    product = models.ForeignKey(
        Product, verbose_name='Purchase - product', related_name='product_purchase', on_delete=models.CASCADE)
...
class Delivery(models.Model):
    purchase = models.ForeignKey(
        Purchase, verbose_name='Delivery - purchase', related_name='delivery_purchase', on_delete=models.CASCADE)
...
class Expertise(models.Model):
    expert = models.ForeignKey(
        Expert, verbose_name='Expert', related_name='expert_expertise', on_delete=models.CASCADE)
    seller_report = models.TextField('Seller report')
    report = models.TextField('Report')
    product = models.ForeignKey(
        Product, verbose_name='Expretise - product', related_name='product_expretise', on_delete=models.CASCADE)
